...
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>${esc(page.title)}</title><meta name="description" content="${esc(description)}"><link rel="canonical" href="${canonical}"><meta property="og:title" content="${esc(page.title)}"><meta property="og:description" content="${esc(description)}"><meta property="og:type" content="website"><meta property="og:url" content="${canonical}"><meta name="theme-color" content="#c94f00"><link rel="icon" href="${url(site.favicon)}"><link rel="stylesheet" href="${url('/assets/site.css')}"><script src="${url('/assets/site.js')}" defer></script></head>
<body><a class="skip-link" href="#main">Skip to content</a><header class="site-header"><div class="header-inner"><a class="brand" href="${url('/')}" aria-label="Caltech Math Meet home"><img src="${url(optimized.get(site.logo)?.url || site.logo)}" alt="Caltech Math Meet" width="115" height="46"><span>Caltech<br><strong>Math Meet</strong></span></a><button class="menu-toggle" aria-controls="navigation" aria-expanded="false">Menu <span aria-hidden="true">☰</span></button><nav id="navigation" aria-label="Main navigation"><a class="home-link" href="${url('/')}"${current('')}>Home</a>${nav}</nav></div></header>
<main id="main" class="${page.slug?'page-content':'home-content'}" tabindex="-1">${page.slug?`<div class="breadcrumbs"><a href="${url('/')}">Home</a><span aria-hidden="true"> / </span>${esc(page.title.split('|')[0].trim())}</div>`:''}${toc}${$.html()}</main>
