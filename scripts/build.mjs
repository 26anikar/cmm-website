...
${page.slug === '' ? '<aside class="stay-connected"><div><p class="eyebrow">Stay connected</p><h2>See you at the next meet.</h2><p>For mailing-list updates, contact the CMM organizers.</p></div><a class="button button-light" href="mailto:cmm-help@caltech.edu?subject=CMM%20mailing%20list">Ask to join the mailing list ↗</a></aside>' : ''}
