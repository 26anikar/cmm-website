...
<footer class="site-footer"><div class="footer-contact-details"><a class="footer-brand" href="${url('/')}" aria-label="Caltech Math Meet home"><img src="${url(optimized.get(site.logo)?.url || site.logo)}" alt="Caltech Math Meet" width="130" height="52" loading="lazy"></a><a href="${url('/contact/')}">Questions? Contact Us</a><a href="mailto:cmm-help@caltech.edu">cmm-help@caltech.edu</a></div>${page.slug === '' ? '<a class="footer-mailing" href="mailto:cmm-help@caltech.edu?subject=CMM%20mailing%20list">Ask to join the mailing list</a>' : ''}</footer></body></html>`;
